...
function loadLegacyPreview() {
    ...
    createPreviewPlayer("playerdiv", {
        ...
        movieOwner: "", movieOwnerId: "", movieId: "${params.flashvars.movieId}", ut: "-1",
...
<script>
    (function() {
        ...
        var studioMode = '${params.flashvars.mode}',
            themeName = '${params.flashvars.tray}',
            copiedId = '',
            editType = null;
