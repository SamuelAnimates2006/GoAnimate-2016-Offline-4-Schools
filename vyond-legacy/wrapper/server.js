...
const Stb = require("./static/pageccbro");
...
module.exports = http
	...
	.listen(env.PORT || env.SERVER_PORT, console.log("Vyond Legacy: Offline has started."))
