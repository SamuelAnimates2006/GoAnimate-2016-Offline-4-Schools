...
if (!isset($_SESSION['login'])) {
  header("Location: /login?returnTo=/charactercreator/business");
  exit();
}
?>
...
<li class="dropdown">
 ...
 <div class="container container-cc">
        <ul class="breadcrumb">
            ...
            '?><?php if (isset($_GET["type"])) { echo "<li><a href=\"/charactercreator/business?style=vyond-legacy\">Business Friendly Characters</a></li>
            <li class=\"active\">Create a new character</li>
        </ul>
<div>
     <div id=\"char_creator_client\" align=\"center\"><object data=\"https://ga.vyond.com/static/animation/cc.swf\" type=\"application/x-shockwave-flash\" id=\"char_creator\" width=\"960\" height=\"600\"><param name=\"align\" value=\"middle\"><param name=\"allowScriptAccess\" value=\"always\"><param name=\"allowFullScreen\" value=\"true\"><param name=\"wmode\" value=\"transparent\"><param name=\"flashvars\" value=\"apiserver=https%3A%2F%2Fvyondlegacy2019.herokuapp.com%2F&amp;m_mode=school&amp;isLogin=Y&amp;isEmbed=0&amp;ctc=go&amp;tlang=en_US&amp;storePath=https%3A%2F%2Fga.vyond.com%2Fstatic%2Fstore%2F%3Cstore%3E&amp;clientThemePath=https%3A%2F%2Fga.vyond.com%2Fstatic%2F%3Cclient_theme%3E&amp;appCode=go&amp;page=&amp;siteId=go&amp;userId=0aWj-HdFtJ5c&amp;themeId=business&amp;ut=23&amp;ft=_sticky_filter_"?><?php if (isset($_GET["type"])) { echo $_GET["type"]; }?><?php echo "\"><param name=\"movie\" value=\"https://ga.vyond.com/static/animation/cc.swf\"></object>
</div>
<script>
jQuery('#char_creator_client').flash({
    ...
    wmode: \"transparent\",
    hasVersion: \"10.3\",
    flashvars: {\"apiserver\":\"https:\/\/vyondlegacy2019.herokuapp.com\/\",\"m_mode\":\"school\",\"isLogin\":\"Y\",\"isEmbed\":\"0\",\"ctc\":\"go\",\"tlang\":\"en_US\",\"storePath\":\"https:\/\/ga.vyond.com\/static\/store\/<store>\",\"clientThemePath\":\"https:\/\/ga.vyond.com\/static\/<client_theme>\",\"appCode\":\"go\",\"page\":\"\",\"siteId\":\"go\",\"userId\":\"0aWj-HdFtJ5c\",\"themeId\":\"business\",\"ut\":23,\"ft\":\"_sticky_filter_"?><?php if (isset($_GET["type"])) { echo $_GET["type"]; }?><?php echo "\"}});
...
function characterSaved()
{
    ...
    window.location = '/charactercreator/business?style=vyond-legacy';
}
</script>     
</div>"; } else { echo "<li class=\"active\">Business Friendly Characters</li>
        </ul>
        <p>Browse characters already available in the Business Friendly theme and use them as a starting point to create new custom characters.</p>
<div id=\"ccbrowser-container\" align=\"center\"><object id=\"obj\" data=\"https://ga.vyond.com/static/animation/cc_browser.swf\" type=\"application/x-shockwave-flash\" id=\"char_creator\" width=\"960\" height=\"1200\"><param name=\"flashvars\" value=\"apiserver=%2F&isEmbed=0&ctc=go&tlang=en_US&storePath=https%3A%2F%2Fga.vyond.com%2Fstatic%2Fstore%2F%3Cstore%3E&clientThemePath=https%3A%2F%2Fga.vyond.com%2Fstatic%2F%3Cclient_theme%3E&appCode=go&siteId=school&st=&userId=0DyHqK6Yj9dM&ut=23&uisa=0&themeId=business&u_info_school=OjI6c2xoVVM3MWJIX05DMnA4cmRBQ2dFd3JvNE5xc2JEc2o4UFB2X1dVd2Eya2RPQisxVTl4d3ZHZHJPYnI4QURFNENWMjNkYm12WFdlUGxLT0g0OG4rekF5ajZhWGRGVTlocmJ4S1JhSWhCVXJlTF9BbXdyQUp3PQ%3D%3D\"> <param name=\"allowScriptAccess\" value=\"always\"> <param name=\"movie\" value=\"https://josephcrosmanplays532.github.io/animation/66453a3ba2cc5e1bvyond/cc_browser.swf\"></object></div>
<script src=\"../../js/vyond/characterCreator/flashvars.js\"></script>
</div>"; } ?><?php echo '
