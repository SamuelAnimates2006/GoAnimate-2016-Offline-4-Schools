...
if (!isset($_SESSION['login'])) {
  header("Location: /login?returnTo=/charactercreator/whiteboard");
  exit();
}
?>
<?php if (isset($_SESSION['login']) && $_GET["style"] == "vyond-legacy") { echo '
<html><head>
<meta charset="utf-8">
...
<link rel="canonical" href="https://action-ouranimate.herokuapp.com/yourvideos">
...
<script type="text/javascript" src="../../js/vyond/characterCreator/script1.js"></script>
...
<script src="../../js/vyond/characterCreator/script2.js"></script>
<!-- Google Tag Manager -->
<script>
</script>
...
<script type="text/javascript" src="../../js/vyond/characterCreator/script3.js"></script>
...
<li class="dropdown">
 ...
 <div class="container container-cc">
        ...
        <ul class="breadcrumb">
            <li><a href="/old">Make a video</a></li>
            '?><?php if (isset($_GET["type"])) { echo "<li><a href=\"/charactercreator/whiteboard?style=vyond-legacy\">Whiteboard Animation Characters</a></li>
            <li class=\"active\">Create a new character</li>
        </ul>
<div>
     <div id=\"char_creator_client\" align=\"center\"><object data=\"https://web.archive.org/web/20190816062815/https://d2qrjeyl4jwu9j.cloudfront.net/animation/cce25167cb1d3404/cc.swf\" type=\"application/x-shockwave-flash\" id=\"char_creator\" width=\"965\" height=\"600\"><param name=\"align\" value=\"middle\"><param name=\"allowScriptAccess\" value=\"always\"><param name=\"allowFullScreen\" value=\"true\"><param name=\"wmode\" value=\"transparent\"><param name=\"flashvars\" value=\"apiserver=https%3A%2F%2Fweb.archive.org%2Fweb%2F20190816062815%2Fhttps%3A%2F%2Fgoanimate4schools.com%2F&amp;m_mode=school&amp;isLogin=Y&amp;isEmbed=0&amp;ctc=go&amp;tlang=en_US&amp;storePath=https%3A%2F%2Fweb.archive.org%2Fweb%2F20190816062815%2Fhttps%3A%2F%2Fd2qrjeyl4jwu9j.cloudfront.net%2Fstore%2F4e75f501cfbf51e3%2F%3Cstore%3E&amp;clientThemePath=https%3A%2F%2Fweb.archive.org%2Fweb%2F20190816062815%2Fhttps%3A%2F%2Fd2qrjeyl4jwu9j.cloudfront.net%2Fstatic%2F642cd772aad8e952%2F%3Cclient_theme%3E&amp;appCode=go&amp;page=&amp;siteId=school&amp;userId=0DyHqK6Yj9dM&amp;themeId=whiteboard&amp;ut=23&amp;ft=_sticky_filter_"?><?php if (isset($_GET["type"])) { echo $_GET["type"]; }?><?php echo "\"><param name=\"movie\" value=\"https://web.archive.org/web/20190816062815/https://d2qrjeyl4jwu9j.cloudfront.net/animation/cce25167cb1d3404/cc.swf\"></object>
</div>
<script>
jQuery('#char_creator_client').flash({
    id: \"char_creator\",
    swf: \"https://web.archive.org/web/20190816062815/https://d2qrjeyl4jwu9j.cloudfront.net/animation/cce25167cb1d3404/cc.swf\",
    height: 600,
    width: 960,
    ...
    flashvars: {\"apiserver\":\"https:\/\/web.archive.org\/web\/20190816062815\/https:\/\/goanimate4schools.com\/\",\"m_mode\":\"school\",\"isLogin\":\"Y\",\"isEmbed\":\"0\",\"ctc\":\"go\",\"tlang\":\"en_US\",\"storePath\":\"https:\/\/web.archive.org\/web\/20190816062815\/https:\/\/d2qrjeyl4jwu9j.cloudfront.net\/store\/4e75f501cfbf51e3\/<store>\",\"clientThemePath\":\"https:\/\/web.archive.org\/web\/20190816062815\/https:\/\/d2qrjeyl4jwu9j.cloudfront.net\/static\/642cd772aad8e952\/<client_theme>\",\"appCode\":\"go\",\"page\":\"\",\"siteId\":\"school\",\"userId\":\"0DyHqK6Yj9dM\",\"themeId\":\"whiteboard\",\"ut\":23,\"ft\":\"_sticky_filter_"?><?php if (isset($_GET["type"])) { echo $_GET["type"]; }?><?php echo "\"}});
...
function characterSaved()
{
    ...
    window.location = '/charactercreator/whiteboard?style=vyond-legacy';
}
</script>     
</div>"; } else { echo "<li class=\"active\">Whiteboard Animation Characters</li>
        </ul>
        <p>Browse characters already available in the Whiteboard Animation theme and use them as a starting point to create new custom characters.</p>
<div id=\"ccbrowser-container\" align=\"center\"><object id=\"obj\" data=\"https://josephcrosmanplays532.github.io/GoAnimate-2016-Assets/animation/414827163ad4eb60/cc_browser.swf\" type=\"application/x-shockwave-flash\" id=\"char_creator\" width=\"960\" height=\"1200\"><param name=\"flashvars\" value=\"apiserver=%2F&isEmbed=0&ctc=go&tlang=en_US&storePath=https%3A%2F%2Fjosephcrosmanplays532.github.io%2FGoAnimate-2016-Assets%2Fstore%2F3a981f5cb2739137%2F%3Cstore%3E&clientThemePath=https%3A%2F%2Fjosephcrosmanplays532.github.io%2FGoAnimate-2016-Assets%2Fstatic%2Fad44370a650793d9%2F%3Cclient_theme%3E&appCode=go&siteId=school&st=&userId=0DyHqK6Yj9dM&ut=23&uisa=0&themeId=family&u_info_school=OjI6c2xoVVM3MWJIX05DMnA4cmRBQ2dFd3JvNE5xc2JEc2o4UFB2X1dVd2Eya2RPQisxVTl4d3ZHZHJPYnI4QURFNENWMjNkYm12WFdlUGxLT0g0OG4rekF5ajZhWGRGVTlocmJ4S1JhSWhCVXJlTF9BbXdyQUp3PQ%3D%3D\"> <param name=\"allowScriptAccess\" value=\"always\"> <param name=\"movie\" value=\"https://josephcrosmanplays532.github.io/Vyond-Legacy-2019-Offline/server/animation/414827163ad4eb60/cc_browser.swf\"></object></div>
<script src=\"../../js/vyond/ccBrowser/flashvars.js\"></script>
</div>"; } ?><?php echo '
...
</html>'; } else { echo "some other goanimate character creators will be coming here soon."; } ?>
