...
$path = "voiceUploads/"; //file to place within the server
...
?>
<p>Please upload the rewritable.mp3 in order for this to work with Vyond Legacy.</p>
<form enctype="multipart/form-data" id="form1" method="post" action="uploadVoices.php">
