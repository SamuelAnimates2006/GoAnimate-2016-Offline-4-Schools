	...
	<div class="container site-header-inside">
		...
		<div class="pull-right">
			<ul id="top-nav" class="top-nav">
				...
				<li class="divider"></li>
				<li>
				<a href="/login?returnTo=/videomaker">Login</a>
				</li>
				<li class="divider"></li>
				<li class="dropdown">
...
<div class="vm-bf" id="topbanner-bf">
	<div class="container">
		...
		<div class="vm-bf-content">
			...
			<div class="actions">
				<a class="btn btn-orange pull-left" href="/login?returnTo=/videomaker/full">Make a Video</a>
	...
	<div class="container">
		...
		<div class="vm-bf-content">
			...
			<div class="actions">
				<button class="btn-flat btn-flat-orange btn-flat-banner" type="button" data-action="biz-preview" data-theme="Comedy World" data-app-type="Video Maker" data-button-text="Preview Video Maker" data-callback="fullscreenStudio('/login?returnTo=/videomaker/full/custom');" title="Comedy World Video Maker">
		...
		<div class="theme" id="thm-business" data-tags="char_creator lipsync starters ext_lib qvm">
			<div class="theme-cell preview">
				...
				<div class="theme-meat">
					...
					<a class="btn btn-orange pull-left" href=" /login?returnTo=/videomaker/full/business">Make a Video</a>
							<a class="btn btn-icon" href=" /login?returnTo=/charactercreator/business">Character Creator</a>
				</div>
			</div>
		...
		<div class="theme" id="thm-sf" data-tags="lipsync char_creator">
			<div class="theme-cell preview">
				...
				<div class="theme-meat">
					...
					<div class="apps">
						<a class="btn btn-orange pull-left" href=" /login?returnTo=/videomaker/full/sf">Make a Video</a>
		...
		<div class="theme" id="thm-botdf" data-tags="">
			<div class="theme-cell">
				...
				<div class="theme-meat">
					...
					<div class="apps">
						<a class="btn btn-orange pull-left" href=" /login?returnTo=/videomaker/full/botdf">Make a Video</a>
					</div>
				</div>
			</div>
		...
		<div class="theme" id="thm-custom" data-tags="lipsync qvm char_creator">
			<div class="theme-cell">
				...
				<div class="theme-meat">
					<h3>Comedy World</h3>
					<div class="apps">
						<a class="btn btn-orange pull-left" href=" /login?returnTo=/videomaker/full/custom">Make a Video</a>
		...
		<div class="theme" id="thm-action" data-tags="lipsync qvm char_creator">
			<div class="theme-cell">
				...
				<div class="theme-meat">
					<h3>Lil Peepz</h3>
					<div class="apps">
						<a class="btn btn-orange pull-left" href=" /login?returnTo=/videomaker/full/action">Make a Video</a>
		...
		<div class="theme" id="thm-politics2" data-tags="lipsync qvm">
			<div class="theme-cell">
				...
				<div class="theme-meat">
					<h3>White Houserz</h3>
					<div class="apps">
						<a class="btn btn-orange pull-left" href=" /login?returnTo=/videomaker/full/politics2">Make a Video</a>
		...
		<div class="theme" id="thm-sticklybiz" data-tags="">
			<div class="theme-cell preview">
				...
				<div class="theme-meat">
					...
					<div class="apps">
						<a class="btn btn-orange pull-left" href=" /login?returnTo=/videomaker/full/sticklybiz">Make a Video</a>
		...
		<div class="theme" id="thm-retro" data-tags="">
			<div class="theme-cell">
				...
				<div class="theme-meat">
					...
					<div class="apps">
						<a class="btn btn-orange pull-left" href=" /login?returnTo=/videomaker/full/retro">Make a Video</a>
		...
		<div class="theme" id="thm-bizmodels" data-tags="">
			<div class="theme-cell preview">
				...
				<div class="theme-meat">
					...
					<div class="apps">
						<a class="btn btn-orange pull-left" href=" /login?returnTo=/videomaker/full/bizmodels">Make a Video</a>
		...
		<div class="theme" id="thm-anime" data-tags="char_creator lipsync qvm">
			<div class="theme-cell">
				...
				<div class="theme-meat">
					<h3>Anime</h3>
					<div class="apps">
						<a class="btn btn-orange pull-left" href=" /login?returnTo=/videomaker/full/anime">Make a Video</a>
		...
		<div class="theme" id="thm-ninjaanime" data-tags="char_creator lipsync">
			<div class="theme-cell">
				...
				<div class="theme-meat">
					<h3>Ninja Anime</h3>
					<div class="apps">
						<a class="btn btn-orange pull-left" href=" /login?returnTo=/videomaker/full/ninjaanime">Make a Video</a>
		...
		<div class="theme" id="thm-spacecitizen" data-tags="lipsync char_creator">
			<div class="theme-cell">
				...
				<div class="theme-meat">
					...
					<div class="apps">
						<a class="btn btn-orange pull-left" href="/login?returnTo=/videomaker/full/spacecitizen">Make a Video</a>
		...
		<div class="theme" id="thm-chibi" data-tags="lipsync qvm char_creator">
			<div class="theme-cell">
				...
				<div class="theme-meat">
					<h3>Chibi Peepz</h3>
					<div class="apps">
						<a class="btn btn-orange pull-left" href=" /login?returnTo=/videomaker/full/chibi">Make a Video</a>
		...
		<div class="theme" id="thm-ninja" data-tags="lipsync qvm char_creator">
			<div class="theme-cell">
				...
				<div class="theme-meat">
					<h3>Chibi Ninjas</h3>
					<div class="apps">
						<a class="btn btn-orange pull-left" href=" /login?returnTo=/videomaker/full/ninja">Make a Video</a>
							<a class="btn btn-icon" href=" /charactercreator/ninja">Character Creator</a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="theme" id="thm-space" data-tags="lipsync qvm char_creator">
			<div class="theme-cell">
				...
				<div class="theme-meat">
					<h3>Space Peepz</h3>
					<div class="apps">
						<a class="btn btn-orange pull-left" href=" /login?returnTo=/videomaker/full/space">Make a Video</a>
		...
		<div class="theme" id="thm-stick" data-tags="char_creator">
			<div class="theme-cell">
				...
				<div class="theme-meat">
					<h3>Stick Figure</h3>
					<div class="apps">
						<a class="btn btn-orange pull-left" href=" /login?returnTo=/videomaker/full/stick">Make a Video</a>
		...
		<div class="theme" id="thm-animal" data-tags="lipsync qvm char_creator">
			<div class="theme-cell">
				...
				<div class="theme-meat">
					...
					<div class="apps">
						<a class="btn btn-orange pull-left" href=" /login?returnTo=/videomaker/full/animal">Make a Video</a>
...
<div id="biz-preview-overlay" class="modal hide">
	...
	<div class="modal-body text-center">
		...
		<p>After you save your video or character, it will take you to the <a href="  /login?returnTo=/dashboard/videos">video list.</a><br> Press Preview Video Maker, or Create a character to get your video ready to record for your youtube channel!</p>
	</div>
...
?>
<?php if (isset($_SESSION['login']) && $_GET["style"] == "vyond-legacy") { header ("Location: ../old"); } else { echo "
	<!DOCTYPE html>
	<html>
	  <head>
